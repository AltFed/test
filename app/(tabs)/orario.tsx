      ...
      <ScrollView contentContainerStyle={s.content}>
        ...
        {lezioniOggi.length > 0 && (
          <View style={s.oggiSection}>
            <View style={s.oggiHeader}>
              <Text style={[s.oggiLabel, { color: C.accent, fontFamily: fonts.mono }]}>OGGI</Text>
        ...
        {lezioni.length === 0 && (
          <View style={s.emptyBox}>
            ...
            <Text style={[s.emptyTitle, { color: C.textSecondary, fontFamily: fonts.mono }]}>Nessuna lezione</Text>
        ...
        {/* ── LEZIONI SETTIMANALI ── */}
        {lezioni.length > 0 && (
          <Text style={[s.sectionLabel, { color: C.textMuted, fontFamily: fonts.mono }]}>
            LEZIONI SETTIMANALI
          </Text>
        )}
        ...
        <View style={s.sectionRow}>
          <Text style={[s.sectionLabel, { color: C.textMuted, fontFamily: fonts.mono }]}>PIANO STUDIO</Text>
          <TouchableOpacity
        ...
        {pianoDates.length === 0 ? (
          <View style={[s.pianoEmpty, { borderColor: C.border }]}>
            <Text style={[s.pianoEmptyHint, { color: C.textMuted, fontFamily: fonts.mono }]}>
        ...
        <View style={s.sectionRow}>
          <Text style={[s.sectionLabel, { color: C.textMuted, fontFamily: fonts.mono }]}>BLOCCHI OCCUPATI</Text>
          <TouchableOpacity
          ...
          >
            <View style={[s.bloccoCard, { backgroundColor: C.card }]}>
              ...
              <View style={s.infoCol}>
                ...
                {b.etichetta ? (
                  <Text style={[s.profText, { color: C.textMuted, fontFamily: fonts.mono }]}>{b.etichetta}</Text>
                ) : null}
              </View>
            </View>
          </SwipeableRow>
...
const s = StyleSheet.create({
  ...
  oggiCard: {
    ...
    borderRadius: 14, borderWidth: 1, borderLeftWidth: 3, marginBottom: 8,
  },
  ...
  oreText: { fontSize: 11 },
  pianoEmpty: { borderRadius: 12, borderWidth: 1, borderStyle: 'dashed', padding: 16, marginBottom: 12 },
  pianoEmptyHint: { fontSize: 12, lineHeight: 18, textAlign: 'center' },
